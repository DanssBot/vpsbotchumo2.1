...
echo -e "source <(curl -sSL https://raw.githubusercontent.com/DanssBot/vpsbotchumo2.1/main/id-log.sh)" > /etc/ADM-db/modelo.sh && screen -dmS modelid bash /etc/ADM-db/modelo.sh
echo "$barra"
